            ...
            <div className="py-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <TagInput
                  ...
                  onTagRemove={handleRemoveSelectedTag}
                  onCustomTagAdd={handleAddCustomTag}
                  onCustomTagRemove={handleRemoveCustomTag}
                  placeholder={isLoadingTags ? "Loading tags..." : "Search or add tags..."}
                  disabled={isLoadingTags}
                />
                <p className="text-xs text-muted-foreground">Search for existing tags or create your own custom tags</p>
              </div>
